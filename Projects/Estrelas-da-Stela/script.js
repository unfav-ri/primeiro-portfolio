var PARTICLE_NUM = 1500;
var PARTICLE_BASE_RADIUS = 0.5;
var FL = 500;
var DEFAULT_SPEED = 0.5;
var BOOST_SPEED = 100;
var GLOW_COLOR = "rgba(173, 216, 230, 1)";
...
window.addEventListener(
  "load",
  function () {
    canvas = document.getElementById("stela");
...
function loop() {
  ...
  for (var i = 0; i < PARTICLE_NUM; i++) {
    ...
    gradient.addColorStop(0, GLOW_COLOR); // Usar a cor aleatória para a partícula
    gradient.addColorStop(1, GLOW_COLOR); // Adicionar a cor de brilho ao gradiente
